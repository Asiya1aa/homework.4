...
public class Main {
    ...
    public static int[] heroesHealth = {270, 280, 240, 260};
    public static int[] heroesDamage = {20, 15, 25, 0};
    public static String[] heroesAttackType = {"бокуто", "кагияма", "кенма", "medic"};
    ...
    public static void helpforgrup() {
        for (int i = 0; i < heroesAttackType.length; i++) {
            ...
            if (heroesHealth[i] > 0 && heroesHealth[i] < 100 && heroesHealth[3] > 0) {
                heroesHealth[i] += 30;
                System.out.println("Medic healt  - "+ heroesAttackType[i] + " 30");
                break;
